...
echo "Checking for update..." | sudo tee /dev/tty1 | sudo tee /dev/pts/* | sudo tee -a ~/AutoPPPwn/PPPwn/upd.log
sudo mkdir /home/www-data
cd /home/www-data
sudo rm -f -r PI-Pwn
echo "Downloading files... " | sudo tee /dev/tty1 | sudo tee /dev/pts/* | sudo tee -a ~/AutoPPPwn/PPPwn/upd.log
git clone https://github.com/stooged/PI-Pwn
currentver=$(<~/AutoPPPwn/PPPwn/ver)
...
sudo rm -f -r PI-Pwn
echo "No update found." | sudo tee /dev/tty1 | sudo tee /dev/pts/* | sudo tee -a ~/AutoPPPwn/PPPwn/upd.log
fi
